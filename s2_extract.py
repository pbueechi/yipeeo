...
class s2:
    ...
    def __init__(self, region, year, crop):
        ...
        self.table_path = r'D:\DATA\yipeeo\Predictors\S2_L2A'
        self.fields = gpd.read_file(f'D:/DATA/yipeeo/Crop_data/Crop_class/{region}/subsample_200/{crop}_{year}.shp')
        ...
        #ToDo Done adjusted this
        if region=='Czechia':
            self.row_head = ['observation', 'cloud_cover[%]'] + list(self.fields.FS_KENNUNG.values)
    ...
    def do_run_extraction(self, n_cores):
        ...
        if n_cores > 1:
            ...
            search_s2 = self.find_existing(search_s2, corenum)
...
if __name__ == '__main__':
    ...
    print(start_pro)
    check_vi()
    # leftovers = [['Czechia', 'maize'], ['Czechia', 'spring_barley'], ['Czechia', 'winter_wheat']]
    # for lo in leftovers:
    #     for year in range(2016,2023):
    #         print(lo, year)
    #         a = s2(region=lo[0], year=year, crop=lo[1])
    #         a.merge_files()
    #         # a.clean_csv()
